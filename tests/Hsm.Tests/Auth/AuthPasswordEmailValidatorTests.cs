...
/// them had a pipeline validator — public signup accepted a 1-character
...
{
    [Fact]
    public void Signup_short_password_is_refused()
    {
    ...
    [Fact]
    public void Signup_malformed_email_is_refused()
    {
        var validator = new SignupValidator();
        var command = new SignupCommand(
    ...
    [Fact]
    public void Signup_well_formed_request_is_valid()
    {
        var validator = new SignupValidator();
        var command = new SignupCommand(
