import { PinRestablecimientoContrasenaTemplateDto } from '@hsm-lib/common/dtos';
    ...
    <>
      <>
        <p>
          ...
          solicitaste un pin para el cambio de clave mediante nuestro sistema.
          <br />
          <br />
          Este contiene un código de verificación necesario para identificarse
          en nuestro sistema. Este código es crucial para garantizar la
          ...
          ingresar el código correctamente. Si tiene algún problema o pregunta,
