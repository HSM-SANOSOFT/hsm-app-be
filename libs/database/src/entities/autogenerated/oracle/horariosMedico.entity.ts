...
Unique,
  ...
  import { PersonalEntity, DepartamentosEntity } from './index';
      ...
      @Index('HRRMDC_DPR_FK_I', [
        'dprCodigo', 
        'dprAraCodigo'
      ])
      @Index('HRRMDC_PRS_FK_I', [
        'prsCodigo'
      ])
...
export class HorariosMedicoEntity {
  ...
  name: 'TIPO_TURNO',
    ...
    length: 1,
    default: 'P',
    comment: "&#x27;I&#x27; iess call center y &#x27;Q&#x27; post quirurgico &#x27;P&#x27; Privado &#x27;R&#x27; RPIS  o   &#x27;O&#x27; en cualquier otro convenio incluso sanoser",
    nullable: true,
  })
